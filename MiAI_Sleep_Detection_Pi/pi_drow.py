...
face_detect = cv2.CascadeClassifier("/home/pi/MiAI_Sleep_Detection_Pi/haarcascade_frontalface_default.xml")
landmark_detect = dlib.shape_predictor("/home/pi/MiAI_Sleep_Detection_Pi/shape_predictor_68_face_landmarks.dat")
